...
- **UX-001**: [Define consistent behavior across affected presets and supported layouts]
- **UX-002**: [Define projection legibility, overflow, contrast, and responsive behavior]
- **UX-003**: [Define keyboard/focus behavior if the feature is interactive, otherwise N/A]
