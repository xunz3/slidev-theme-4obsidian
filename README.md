# obsidian-theme-lilas

[![NPM version](https://img.shields.io/npm/v/obsidian-theme-lilas?color=3AB9D4&label=)](https://www.npmjs.com/package/obsidian-theme-lilas)
...
```bash
pnpm add obsidian-theme-lilas
```

Then add the following frontmatter to your `slides.md`:

<pre><code>---
theme: <b>obsidian-theme-lilas</b>
title: My Deck
